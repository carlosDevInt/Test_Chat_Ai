...
declare function parseToolCall<TOOLS extends ToolSet>({ toolCall, tools, repairToolCall, refineToolInput, messages, instructions, abortSignal, }: {
    toolCall: LanguageModelV4ToolCall;
    tools: TOOLS | undefined;
 ...
 */
declare function validateToolContext<CONTEXT>({ toolName, context, contextSchema, }: {
    toolName: string;
    context: unknown;
